...
var events = allEvents{
	{
		ID:          "1",
		Title:       "Fast introduction",
		Description: "I'm a Beyond, Developer, and Student!! 🥅 2021 Goals: Contribute more to Open Source projects",
	},
	{
		ID:          "2",
		Title:       "Promo time 😜",
		Description: "https://github.com/NANI1734",
	},
}

func homeLink(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "Welcome bro!, check our endspoint /event, /events, /events/{id}")
}
